...
package edu.msu.cse.cops.server.consistency.cluster;
...
public class Cluster implements Serializable {
    ...
    private final Map<Zone, List<String>> nodesPerZone;
    ...
    private final Map<Integer, String> partitionIdToNodeId;
    ...
    public Cluster(String name, List<Node> nodes, List<Zone> zones) {
        ...
        this.nodesPerZone = new LinkedHashMap<Zone, List<String>>();
        ...
        this.partitionIdToNodeId = new HashMap<Integer, String>();
        ...
        if(zones.size() != 0) {
            ...
            for(Zone zone: zones) {
                ...
                nodesPerZone.put(zone, new ArrayList<String>());
            ...
            nodesPerZone.put(defaultZone, new ArrayList<String>());
            partitionsPerZone.put(defaultZone, new ArrayList<Integer>());
        }

        this.nodesById = new LinkedHashMap<String, Node>(nodes.size());
        for(Node node: nodes) {
    ...
    public Set<String> getNodeIds() {
        ...
        return new TreeSet<String>(nodeIds);
    }
    ...
    public Zone getZoneById(int id) {
        ...
        if(zone == null) {
            throw new ConsistencyException("No such zone in cluster: " + id
     ...
     */
    public Set<String> getNodeIdsInZone(Integer zoneId) {
        return new TreeSet<String>(nodesPerZone.get(getZoneById(zoneId)));
    }
     ...
     */
    public Map<Integer, String> getPartitionIdToNodeIdMap() {
        return new HashMap<Integer, String>(partitionIdToNodeId);
    }

    public Node getNodeById(String id) {
        Node node = nodesById.get(id);
        if(node == null)
            throw new ConsistencyException("No such node in cluster: " + id);
        return node;
    }
