...
for _Num in 1 2 3 4 5 6 7 8 ; do \
  tmux send-keys -t ${_Num} "cd cops-server" ENTER; done


tmux send-keys -t 9 "cd cops-client" ENTER
tmux send-keys -t 10 "cd cops-client" ENTER
tmux send-keys -t 11 "cd cops-client" ENTER
