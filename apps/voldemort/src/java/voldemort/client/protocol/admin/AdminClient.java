...
import voldemort.consistency.versioning.VectorClockUtils;
...
import voldemort.store.readonly.*;
...
public class AdminClient implements Closeable {
    ...
    public class MetadataManagementOperations {
        ...
        private Versioned<Properties> getMetadataVersion(Collection<Integer> nodeIds) {
            ...
            for(Integer nodeId: nodeIds) {
                try {
                    ...
                    Version curVersion = versionedProps.getVersion();
        ...
        public void updateRemoteMetadata(Collection<Integer> nodeIds, String key, String value) {
            ...
            for(Integer nodeId: nodeIds) {
                if(updatedVersion == null) {
                    updatedVersion = metadataMgmtOps.getRemoteMetadata(nodeId, key)
                                                                  .getVersion();
                } else {
                    updatedVersion = updatedVersion.merge(metadataMgmtOps.getRemoteMetadata(nodeId,
                                                                                                          key)
                                                                                       .getVersion());
                }
         ...
         *         {@link voldemort.consistency.versioning.Version}
         */
    ...
    public class RebalancingOperations {
        ...
        public Versioned<Cluster> getLatestCluster(List<Integer> requiredNodes) {
            Versioned<Cluster> latestCluster = null;
            try {
                latestCluster = new Versioned<Cluster>(getAdminClientCluster());
