...
import voldemort.consistency.versioning.ChainedResolver;
import voldemort.consistency.versioning.InconsistencyResolver;
import voldemort.consistency.versioning.TimeBasedInconsistencyResolver;
import voldemort.consistency.versioning.VectorClockInconsistencyResolver;
...
public abstract class AbstractStoreClientFactory implements StoreClientFactory {
    ...
    public RoutedStoreConfig routedStoreConfig;
    ...
    Map<Integer, Store<ByteArray, byte[], byte[]>> clientMappingToUse = Maps.newHashMap();
    ...
    public Map<Integer, Store<ByteArray, byte[], byte[]>> getStores() {
        return this.clientMappingToUse;
    }
    ...
    public <K, V, T> Store<K, V, T> getRawStore(String storeName,
        ...
        this.clientMappingToUse = clientMapping;
