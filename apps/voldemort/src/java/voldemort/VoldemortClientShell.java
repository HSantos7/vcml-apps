...
public class VoldemortClientShell {
    ...
    public static StoreClient<Object, Object> client;

    public static SocketStoreClientFactory factory;

    public static StoreDefinition storeDef;

    public static RoutingStrategy routingStrategy;
    ...
    protected void processNewMessage(String putArgStr) {
        MutableInt parsePos = new MutableInt(0);
        Object key = parseKey(putArgStr, parsePos);
        putArgStr = putArgStr.substring(parsePos.intValue());
        Object value = parseValue(putArgStr, parsePos);
        client.newMessage(key, value);
    }
    ...
    boolean evaluateCommand(String line, boolean printCommands) {
        try {
            ...
            } else if(line.toLowerCase().startsWith("new")) {
                processNewMessage(line.substring("new".length()));
