    ...
    public void badKeyReaderWriteBadKeys(String fileName, boolean addWhiteSpace) {
        ...
        try {
            ...
            for(int i = 0; i < 1000; ++i) {
                ...
                fileWriter.write(voldemort.consistency.utils.ByteUtils.toHexString(keyb) + "\n");
                if(addWhiteSpace) {
    ...
    public void badKeyReaderWriteOrphanKeys(String fileName, boolean addWhiteSpace) {
        ...
        try {
            ...
            for(int i = 0; i < 1000; ++i) {
                int numValues = (i % 3) + 1;
                byte[] keyb = TestUtils.randomBytes(10);
                String keyLine = voldemort.consistency.utils.ByteUtils.toHexString(keyb) + "," + numValues;
