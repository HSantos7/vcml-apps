...
public class ConsistencyFixWorkerTest {
    ...
    public void testRepair(int putNodes[], boolean orphan) {
        ...
        String hexKey = voldemort.consistency.utils.ByteUtils.toHexString(bKey);
        voldemort.consistency.utils.ByteArray baKey = new voldemort.consistency.utils.ByteArray(bKey);
        ...
        for(int putNode: putNodes) {
            NodeValue<voldemort.consistency.utils.ByteArray, byte[]> nodeKeyValue;
