...
public class ConsistencyCheckTest {
    ...
    public void testCleanIneligibleKeys() {
        ...
        // setup
        Map<voldemort.consistency.utils.ByteArray, Map<ConsistencyCheck.Value, Set<ClusterNode>>> map = new HashMap<voldemort.consistency.utils.ByteArray, Map<ConsistencyCheck.Value, Set<ClusterNode>>>();
        ...
        int requiredWrite = 2;
        voldemort.consistency.utils.ByteArray key1 = new voldemort.consistency.utils.ByteArray(value1);
    ...
    public void testKeyVersionToString() {
        ...
        voldemort.consistency.utils.ByteArray key = new voldemort.consistency.utils.ByteArray(keyBytes);
        long now = System.currentTimeMillis();
    ...
    public void testKeyFetchTracker() {
        ...
        tracker.recordFetch(cn0_1, new voldemort.consistency.utils.ByteArray(value1));
        tracker.recordFetch(cn0_2, new voldemort.consistency.utils.ByteArray(value1));
        tracker.recordFetch(cn0_3, new voldemort.consistency.utils.ByteArray(value1));
        tracker.recordFetch(cn0_4, new voldemort.consistency.utils.ByteArray(value1));
        tracker.recordFetch(cn0_1, new voldemort.consistency.utils.ByteArray(value2));
        tracker.recordFetch(cn0_2, new voldemort.consistency.utils.ByteArray(value2));
        tracker.recordFetch(cn0_3, new voldemort.consistency.utils.ByteArray(value2));
        assertNull(tracker.nextFinished());
        tracker.recordFetch(cn0_4, new voldemort.consistency.utils.ByteArray(value2));
        assertEquals(new voldemort.consistency.utils.ByteArray(value1), tracker.nextFinished());
        assertNull(tracker.nextFinished());
        // multiple fetch on same node same key
        tracker.recordFetch(cn0_1, new voldemort.consistency.utils.ByteArray(value3));
        tracker.recordFetch(cn0_2, new voldemort.consistency.utils.ByteArray(value3));
        tracker.recordFetch(cn0_3, new voldemort.consistency.utils.ByteArray(value3));
        tracker.recordFetch(cn0_4, new voldemort.consistency.utils.ByteArray(value3));
        tracker.recordFetch(cn0_4, new voldemort.consistency.utils.ByteArray(value3));
        tracker.recordFetch(cn0_4, new voldemort.consistency.utils.ByteArray(value3));
        assertEquals(new voldemort.consistency.utils.ByteArray(value2), tracker.nextFinished());

        tracker.recordFetch(cn0_1, new voldemort.consistency.utils.ByteArray(value4));
        tracker.recordFetch(cn0_2, new voldemort.consistency.utils.ByteArray(value4));
        tracker.recordFetch(cn0_3, new voldemort.consistency.utils.ByteArray(value4));

        assertNull(tracker.nextFinished());

        tracker.finishAll();
        List<voldemort.consistency.utils.ByteArray> expectedFinished = Arrays.asList(new voldemort.consistency.utils.ByteArray(value3),
                                                         new voldemort.consistency.utils.ByteArray(value4));

        List<voldemort.consistency.utils.ByteArray> actualFinished = Arrays.asList(tracker.nextFinished(),
    ...
    public void testOnePartitionEndToEndBasedOnVersion() throws Exception {
        ...
        ArrayList<Pair<voldemort.consistency.utils.ByteArray, Versioned<byte[]>>> n0store = new ArrayList<Pair<voldemort.consistency.utils.ByteArray, Versioned<byte[]>>>();
        ArrayList<Pair<voldemort.consistency.utils.ByteArray, Versioned<byte[]>>> n1store = new ArrayList<Pair<voldemort.consistency.utils.ByteArray, Versioned<byte[]>>>();
        ArrayList<Pair<voldemort.consistency.utils.ByteArray, Versioned<byte[]>>> n2store = new ArrayList<Pair<voldemort.consistency.utils.ByteArray, Versioned<byte[]>>>();
        ArrayList<Pair<voldemort.consistency.utils.ByteArray, Versioned<byte[]>>> n3store = new ArrayList<Pair<voldemort.consistency.utils.ByteArray, Versioned<byte[]>>>();
        ArrayList<voldemort.consistency.utils.ByteArray> keysHashedToPar0 = new ArrayList<voldemort.consistency.utils.ByteArray>();
        ...
        while(keysHashedToPar0.size() < 7) {
            // generate random key
            Map<voldemort.consistency.utils.ByteArray, byte[]> map = ServerTestUtils.createRandomKeyValuePairs(1);
            voldemort.consistency.utils.ByteArray key = map.keySet().iterator().next();
        ...
        voldemort.consistency.utils.ByteArray k6 = keysHashedToPar0.get(6);
        voldemort.consistency.utils.ByteArray k5 = keysHashedToPar0.get(5);
        voldemort.consistency.utils.ByteArray k4 = keysHashedToPar0.get(4);
        voldemort.consistency.utils.ByteArray k3 = keysHashedToPar0.get(3);
        voldemort.consistency.utils.ByteArray k2 = keysHashedToPar0.get(2);
        voldemort.consistency.utils.ByteArray k1 = keysHashedToPar0.get(1);
